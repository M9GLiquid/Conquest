...
public class Kingdom extends Objective{
	...
	public void join(Player player){
		...
		Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "lp user " + player.getName() + " parent add " + getName() + " " + Main.getInstance().getServer().getServerName());
	}
	...
	public void leave(Player player){
		...
		Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "lp user " + player.getName() + " parent remove " + getName() + " " + Main.getInstance().getServer().getServerName());
	}
