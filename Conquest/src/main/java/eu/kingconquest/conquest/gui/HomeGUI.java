...
public class HomeGUI extends ChestGui{
	...
	private void reloadButton(){
        setItem(2, new ItemStack(Material.RED_WOOL), player -> {
	...
	private void playerButton(){
        ...
        setSkullItem(slot, head, player ->
                        new PlayerGUI(player, this, null), "&3Player Management Menu:", displayInfo()
				);
		slot++;
	}
	...
	private void helpButton(){
        setItem(slot, new ItemStack(Material.BOOK), player ->
                        new HelpGUI(player, this), "&2Help Information",
				"");
		slot++;
	}
	...
	private void townButton(){
        setItem(slot, new ItemStack(Material.BEACON), player ->
                        new TownGUI(player, this), "&6Town Menu",
				"&4Admin only:" 
						+"\n&aCreate &7a Town!"
						+ "\n&3Edit &7a Town!"
						+ "\n&cDelete &7a Town!"
	...
	private void villageButton(){
        setItem(slot, new ItemStack(Material.BEACON), player ->
                        new VillageGUI(player, this), "&6Village Menu",
				"&4Admin only:" 
						+"\n&aCreate &7a Village!"
						+ "\n&3Edit &7a Village!"
						+ "\n&cDelete &7a Village!"
	...
	private void conflictButton(){
        setItem(slot, new ItemStack(Material.ENDER_PEARL), player ->
                        new ConflictGUI(player, this), "&6Conflict Gui",
	...
	private void resetButton(){
        setItem(slot, new ItemStack(Material.BARRIER), player ->
                        new ResetGUI(player, this), "&6Reset Menu",
				"&6"
						+ "\n");
		slot++;
	}
	...
	private void rewardButton(){
        ...
        setItem(slot, new ItemStack(Material.ENDER_CHEST), player -> new RewardGUI(player, this), "&6Reward Box Menu", details);
		slot++;
	}
