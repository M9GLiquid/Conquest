...
public class ColorManager{
	...
	public static Material intToMaterial(int color) {
		switch (color) {
			case 0:
				return Material.BLUE_STAINED_GLASS; // Dark Blue
			case 1:
				return Material.GREEN_STAINED_GLASS; // Dark Green
			case 2:
				return Material.CYAN_STAINED_GLASS;  // Dark Aqua/Cyan
			case 3:
				return Material.RED_STAINED_GLASS; // Dark Red
			case 4:
				return Material.PURPLE_STAINED_GLASS; // Dark Purple
			case 5:
				return Material.LIGHT_BLUE_STAINED_GLASS;  // Blue
			case 6:
				return Material.LIME_STAINED_GLASS;  // Green / Lime
			case 7:
				return Material.PINK_STAINED_GLASS;  // Pink
			case 8:
				return Material.YELLOW_STAINED_GLASS;  // Yellow
			default:
				return Material.WHITE_STAINED_GLASS;  // White
		}
	}
