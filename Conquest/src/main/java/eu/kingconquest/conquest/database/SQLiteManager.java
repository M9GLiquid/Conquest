    ...
    private void villageTableCreate() {
        try {
            database.updateSQL("CREATE TABLE IF NOT EXISTS " + tablePrefix + "villages (" +
                    "    `village_uuid` CHAR(45) PRIMARY KEY NOT NULL," +
                    "    `world_uuid` CHAR(45) NOT NULL," +
                    "    `name` CHAR(25) NOT NULL," +
                    "    `location.X` REAL NOT NULL," +
                    "    `location.Y` REAL NOT NULL," +
                    "    `location.Z` REAL NOT NULL," +
                    "    `spawn.X` REAL NOT NULL," +
                    "    `spawn.Y` REAL NOT NULL," +
                    "    `spawn.Z` REAL NOT NULL," +
                    "    `spawn.Yaw` REAL NOT NULL," +
                    "    `spawn.Pitch` REAL NOT NULL," +
                    "    `owner` CHAR(45) NOT NULL," +
                    "    `parent` CHAR(45) NOT NULL);");
        } catch (SQLException | ClassNotFoundException e) {
            e.printStackTrace();
        }
    }
    ...
    private void townTableCreate() {
        try {
            database.updateSQL("CREATE TABLE IF NOT EXISTS " + tablePrefix + "towns (" +
                    "    town_uuid CHAR(45) PRIMARY KEY NOT NULL," +
                    "    world_uuid CHAR(45) NOT NULL," +
                    "    name CHAR(25) NOT NULL," +
                    "    `location.X` REAL NOT NULL," +
                    "    `location.Y` REAL NOT NULL," +
    ...
    private void worldTableCreate() {
        try {
            database.updateSQL("CREATE TABLE IF NOT EXISTS " + tablePrefix + "worlds (" +
                    "    world_uuid CHAR(45) PRIMARY KEY NOT NULL," +
                    "    enable_date CHAR(45) NOT NULL," +
                    "    disable_date CHAR(45) NOT NULL," +
                    "    enabled CHAR(5) NOT NULL);");
        } catch (SQLException | ClassNotFoundException e) {
            e.printStackTrace();
        }
    }
    ...
    private void kingdomTableCreate() {
        try {
            database.updateSQL("CREATE TABLE IF NOT EXISTS " + tablePrefix + "kingdoms (" +
                    "    kingdom_uuid CHAR(45) PRIMARY KEY NOT NULL," +
                    "    world_uuid CHAR(45) NOT NULL," +
    ...
    private void userTableCreate() {
        try {
            database.updateSQL("CREATE TABLE IF NOT EXISTS " + tablePrefix + "users (" +
                    "    user_uuid CHAR(45) PRIMARY KEY NOT NULL," +
                    "    kingdom_uuid CHAR(45) NOT NULL," +
                    "    hierarchy CHAR(10) NOT NULL);");
        } catch (SQLException | ClassNotFoundException e) {
            e.printStackTrace();
        }
    }
